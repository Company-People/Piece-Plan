let pieces = [
  ...
  },
  {
    ...
    content: "1. 공부하고자 하는 내용에 대한 구글링을 30분간 진행하세요. \n 개념에 대한 정리를 1시간30분 동안 반복하여 손글씨로 써보세요^^",
    share: true,
    favoriteCnt: 0,
    time: 2,
    writeDate: "2022-10-04",
  ...
  },
  {
    ...
    subTitle: "너도 마블 디자이너??",
    content: "[김락희의 인체 드로잉]을 보고 인체 드로잉 2시간 동안 근육 공부 \n [쉽게 배우는 인체 드로잉] 보고 1시간 손 공부",
    share: true,
    favoriteCnt: 0,
    time: 3,
